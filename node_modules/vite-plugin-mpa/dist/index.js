...
var require_async2 = __commonJS((exports) => {
  ...
  function readdir(directory, settings, callback) {
    settings.fs.readdir(directory, (readdirError, names) => {
      ...
      const filepaths = names.map((name2) => common.joinPathSegments(directory, name2, settings.pathSegmentSeparator));
  ...
  return {
    ...
    closeBundle() {
      ...
      if (options.filename !== "index.html") {
        _shelljs2.default.ls(resolve(`${dest}/src/pages/*/*.html`)).forEach((html) => {
          _shelljs2.default.mv(html, html.replace(options.filename, "index.html"));
        });
      }
      _shelljs2.default.mv(resolve(`${dest}/src/pages/*`), resolve(dest));
      _shelljs2.default.rm("-rf", resolve(`${dest}/src`));
      _shelljs2.default.rm("-rf", resolve(`${dest}/index.html`));
    }
  };
}
