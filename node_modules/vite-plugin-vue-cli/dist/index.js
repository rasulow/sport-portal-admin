...
var require_umd = __commonJS((exports, module) => {
  (function(global2, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global2.deepmerge = factory();
  })(exports, function() {
    "use strict";
...
var require_Chainable = __commonJS((exports, module) => {
...
var require_ChainedMap = __commonJS((exports, module) => {
  var merge2 = require_umd();
  var Chainable = require_Chainable();
  module.exports = class extends Chainable {
    ...
    order() {
      ...
      names.forEach((name2) => {
        ...
        const {__before, __after} = entries[name2];
        if (__before && order.includes(__before)) {
          order.splice(order.indexOf(name2), 1);
          order.splice(order.indexOf(__before), 0, name2);
        } else if (__after && order.includes(__after)) {
          order.splice(order.indexOf(name2), 1);
          order.splice(order.indexOf(__after) + 1, 0, name2);
        }
      });
    ...
    values() {
      const {entries, order} = this.order();
      return order.map((name2) => entries[name2]);
    }
    get(key) {
    ...
    merge(obj, omit = []) {
      Object.keys(obj).forEach((key) => {
        ...
        if (!Array.isArray(value) && typeof value !== "object" || value === null || !this.has(key)) {
          ...
          this.set(key, merge2(this.get(key), value));
        }
      });
      return this;
    }
...
var require_ChainedSet = __commonJS((exports, module) => {
  var Chainable = require_Chainable();
  module.exports = class extends Chainable {
    constructor(parent) {
      super(parent);
...
var require_Orderable = __commonJS((exports, module) => {
  module.exports = (Class) => class extends Class {
    before(name2) {
      if (this.__after) {
        throw new Error(`Unable to set .before(${JSON.stringify(name2)}) with existing value for .after()`);
      }
      this.__before = name2;
      return this;
    }
    after(name2) {
      if (this.__before) {
        throw new Error(`Unable to set .after(${JSON.stringify(name2)}) with existing value for .before()`);
      }
      this.__after = name2;
      return this;
    }
...
var require_Plugin = __commonJS((exports, module) => {
  var ChainedMap = require_ChainedMap();
  var Orderable = require_Orderable();
  module.exports = Orderable(class extends ChainedMap {
    constructor(parent, name2, type = "plugin") {
      super(parent);
      this.name = name2;
      this.type = type;
      this.extend(["init"]);
...
var require_Resolve = __commonJS((exports, module) => {
  var ChainedMap = require_ChainedMap();
  var ChainedSet = require_ChainedSet();
  ...
  module.exports = class extends ChainedMap {
    ...
    plugin(name2) {
      return this.plugins.getOrCompute(name2, () => new Plugin(this, name2, "resolve.plugin"));
    }
    toConfig() {
    ...
    merge(obj, omit = []) {
      ...
      if (!omit.includes("plugin") && "plugin" in obj) {
        Object.keys(obj.plugin).forEach((name2) => this.plugin(name2).merge(obj.plugin[name2]));
      }
...
var require_ResolveLoader = __commonJS((exports, module) => {
...
var require_DevServer = __commonJS((exports, module) => {
  var ChainedMap = require_ChainedMap();
  var ChainedSet = require_ChainedSet();
  module.exports = class extends ChainedMap {
    constructor(parent) {
  ...
  module.exports = Orderable(class extends ChainedMap {
    ...
    merge(obj, omit = []) {
      ...
      if (!omit.includes("options") && "options" in obj) {
        this.options(merge2(this.store.get("options") || {}, obj.options));
      }
...
var require_Rule = __commonJS((exports, module) => {
  ...
  var Orderable = require_Orderable();
  var Use = require_Use();
  var Rule = Orderable(class extends ChainedMap {
    constructor(parent, name2, ruleType = "rule") {
      super(parent);
      this.name = name2;
      this.names = [];
    ...
    use(name2) {
      return this.uses.getOrCompute(name2, () => new Use(this, name2));
    }
    rule(name2) {
      return this.rules.getOrCompute(name2, () => new Rule(this, name2, "rule"));
    }
    oneOf(name2) {
      return this.oneOfs.getOrCompute(name2, () => new Rule(this, name2, "oneOf"));
    }
    pre() {
    ...
    merge(obj, omit = []) {
      ...
      if (!omit.includes("use") && "use" in obj) {
        Object.keys(obj.use).forEach((name2) => this.use(name2).merge(obj.use[name2]));
      }
      if (!omit.includes("rules") && "rules" in obj) {
        Object.keys(obj.rules).forEach((name2) => this.rule(name2).merge(obj.rules[name2]));
      }
      if (!omit.includes("oneOf") && "oneOf" in obj) {
        Object.keys(obj.oneOf).forEach((name2) => this.oneOf(name2).merge(obj.oneOf[name2]));
      }
...
var require_Module = __commonJS((exports, module) => {
  var ChainedMap = require_ChainedMap();
  ...
  module.exports = class extends ChainedMap {
    ...
    defaultRule(name2) {
      return this.defaultRules.getOrCompute(name2, () => new Rule(this, name2, "defaultRule"));
    }
    rule(name2) {
      return this.rules.getOrCompute(name2, () => new Rule(this, name2, "rule"));
    }
    ...
    merge(obj, omit = []) {
      if (!omit.includes("rule") && "rule" in obj) {
        Object.keys(obj.rule).forEach((name2) => this.rule(name2).merge(obj.rule[name2]));
      }
      if (!omit.includes("defaultRule") && "defaultRule" in obj) {
        Object.keys(obj.defaultRule).forEach((name2) => this.defaultRule(name2).merge(obj.defaultRule[name2]));
      }
...
var require_Optimization = __commonJS((exports, module) => {
  var ChainedMap = require_ChainedMap();
  var Plugin = require_Plugin();
  module.exports = class extends ChainedMap {
    constructor(parent) {
    ...
    minimizer(name2) {
      if (Array.isArray(name2)) {
        throw new Error("optimization.minimizer() no longer supports being passed an array. Either switch to the new syntax (https://github.com/neutrinojs/webpack-chain#config-optimization-minimizers-adding) or downgrade to webpack-chain 4. If using Vue this likely means a Vue plugin has not yet been updated to support Vue CLI 4+.");
      }
      return this.minimizers.getOrCompute(name2, () => new Plugin(this, name2, "optimization.minimizer"));
    }
    toConfig() {
      return this.clean(Object.assign(this.entries() || {}, {
    ...
    merge(obj, omit = []) {
      if (!omit.includes("minimizer") && "minimizer" in obj) {
        Object.keys(obj.minimizer).forEach((name2) => this.minimizer(name2).merge(obj.minimizer[name2]));
      }
...
var require_object = __commonJS((exports) => {
  ...
  exports.objectToString = (value, space, next, key) => {
    ...
    const toString2 = OBJECT_TYPES[Object.prototype.toString.call(value)];
    return toString2 ? toString2(value, space, next, key) : void 0;
  };
...
var require_Config = __commonJS((exports, module) => {
  ...
  var ChainedSet = require_ChainedSet();
  var Resolve = require_Resolve();
  var ResolveLoader = require_ResolveLoader();
  var Output = require_Output();
  var DevServer = require_DevServer();
  var Plugin = require_Plugin();
  var Module = require_Module();
  var Optimization = require_Optimization();
  ...
  module.exports = class extends ChainedMap {
    ...
    static toString(config, {verbose = false, configPrefix = "config"} = {}) {
      const {stringify} = require_dist();
      return stringify(config, (value, indent, stringify2) => {
        if (value && value.__pluginName) {
          const prefix = `/* ${configPrefix}.${value.__pluginType}('${value.__pluginName}') */
`;
          const constructorExpression = value.__pluginPath ? `(require(${stringify2(value.__pluginPath)}))` : value.__pluginConstructorName;
          if (constructorExpression) {
            const args = stringify2(value.__pluginArgs).slice(1, -1);
            return `${prefix}new ${constructorExpression}(${args})`;
          }
          return prefix + stringify2(value.__pluginArgs && value.__pluginArgs.length ? {args: value.__pluginArgs} : {});
        }
...
`;
    ...
    entry(name2) {
      return this.entryPoints.getOrCompute(name2, () => new ChainedSet(this));
    }
    plugin(name2) {
      return this.plugins.getOrCompute(name2, () => new Plugin(this, name2));
    }
    toConfig() {
    ...
    merge(obj = {}, omit = []) {
      ...
      if (!omit.includes("entry") && "entry" in obj) {
        Object.keys(obj.entry).forEach((name2) => this.entry(name2).merge([].concat(obj.entry[name2])));
      }
      if (!omit.includes("plugin") && "plugin" in obj) {
        Object.keys(obj.plugin).forEach((name2) => this.plugin(name2).merge(obj.plugin[name2]));
      }
...
var require_join_arrays = __commonJS((exports) => {
  "use strict";
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  var _mergeWith2 = require_mergeWith();
  ...
  var isArray2 = Array.isArray;
  function joinArrays() {
    var _ref = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, customizeArray = _ref.customizeArray, customizeObject = _ref.customizeObject, key = _ref.key;
...
var require_join_arrays_smart = __commonJS((exports) => {
  "use strict";
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.uniteEntries = exports.uniteRules = void 0;
  var _unionWith2 = require_unionWith();
  var _unionWith3 = _interopRequireDefault(_unionWith2);
  var _differenceWith2 = require_differenceWith();
  var _differenceWith3 = _interopRequireDefault(_differenceWith2);
  var _mergeWith2 = require_mergeWith();
  var _mergeWith3 = _interopRequireDefault(_mergeWith2);
  var _isEqual2 = require_isEqual();
  ...
  function uniteRules(rules, key, newRule, rule) {
    ...
    if (newRule.loader) {
      ...
      var expandEntry = function expandEntry2(loader) {
        return typeof loader === "string" ? {loader} : loader;
      };
      var unwrapEntry = function unwrapEntry2(entry) {
  ...
  function isSameValue(a, b) {
    var _map = [a, b].map(function(value) {
      return isArray2(value) ? [].concat(_toConsumableArray(value)).sort() : value;
    }), _map2 = _slicedToArray(_map, 2), propA = _map2[0], propB = _map2[1];
    return (0, _isEqual3.default)(propA, propB);
  }
  function areEqualEntries(newEntry, entry) {
    var loaderNameRe = /^([^?]+)/ig;
    var _entry$loader$match = entry.loader.match(loaderNameRe), _entry$loader$match2 = _slicedToArray(_entry$loader$match, 1), loaderName = _entry$loader$match2[0];
    var _newEntry$loader$matc = newEntry.loader.match(loaderNameRe), _newEntry$loader$matc2 = _slicedToArray(_newEntry$loader$matc, 1), newLoaderName = _newEntry$loader$matc2[0];
...
var require_unique = __commonJS((exports) => {
  ...
  function mergeUnique(key, uniques) {
    var getter = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : function(a) {
      return a;
    };
...
var require_lib = __commonJS((exports, module) => {
  ...
  var _differenceWith2 = require_differenceWith();
  var _differenceWith3 = _interopRequireDefault(_differenceWith2);
  var _joinArrays = require_join_arrays();
  var _joinArrays2 = _interopRequireDefault(_joinArrays);
  var _joinArraysSmart = require_join_arrays_smart();
  var _unique = require_unique();
  ...
  function merge2() {
    ...
    if (sources.length === 1) {
      if (Array.isArray(sources[0])) {
        return _mergeWith3.default.apply(void 0, [{}].concat(_toConsumableArray(sources[0]), [(0, _joinArrays2.default)(sources[0])]));
      }
      if (sources[0].customizeArray || sources[0].customizeObject) {
        return function() {
          ...
          if (Array.isArray(structures[0])) {
            return _mergeWith3.default.apply(void 0, [{}].concat(_toConsumableArray(structures[0]), [(0, _joinArrays2.default)(sources[0])]));
          }
          return _mergeWith3.default.apply(void 0, [{}].concat(structures, [(0, _joinArrays2.default)(sources[0])]));
        };
      }
      return sources[0];
    }
    return _mergeWith3.default.apply(void 0, [{}].concat(sources, [(0, _joinArrays2.default)()]));
  }
  var mergeSmart = merge2({
  ...
  var mergeMultiple = function mergeMultiple2() {
    for (var _len3 = arguments.length, sources = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      sources[_key3] = arguments[_key3];
    }
    return (0, _values3.default)(merge2(sources));
  };
  var mergeStrategy = function mergeStrategy2() {
  ...
  var mergeSmartStrategy = function mergeSmartStrategy2() {
    var rules = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return merge2({
      customizeArray: function customizeArray(a, b, key) {
...
// src/index.ts
var _path = require('path'); var _path2 = _interopRequireDefault2(_path);
...
// src/lib/ast.ts
var _traverse = require('@babel/traverse'); var _traverse2 = _interopRequireDefault2(_traverse);



var _types = require('@babel/types');
function parseAlias(alias, dir) {
  let realDir = dir;
  let match = false;
  if (isArray(alias)) {
...
function findRequireContextSyntaxResult(babelResult, id, alias) {
  const expressionResult = extractRequireContextExpression(babelResult) || [];
  const currentCodeDirName = _path2.default.dirname(id);
  return expressionResult.map((er) => {
    ...
    const dirname = match ? realDir : _path2.default.join(currentCodeDirName, directory);
    return {
      dirname,
...
function findModuleHotSyntaxResult(babelResult) {
...
function extractRequireContextExpression(babelResult) {
  let resList = [];
  _traverse2.default.call(void 0, babelResult.ast, {
    CallExpression(path4) {
      const node = path4.node;
      const {start, end} = node;
      const calleeNode = path4.get("callee").node;
      if (_types.isMemberExpression.call(void 0, path4.node.callee, {computed: false}) && _types.isIdentifier.call(void 0, calleeNode.object, {name: "require"}) && _types.isIdentifier.call(void 0, calleeNode.property, {name: "context"})) {
        const ret = [];
...
function extractModuleHotExpression(babelResult) {
  let resList = [];
  _traverse2.default.call(void 0, babelResult.ast, {
    Identifier(path4) {
      const node = path4.node;
      if (_types.isIdentifier.call(void 0, node, {name: "module"})) {
        resList.push({
          start: node.start,
          end: node.start
        });
...
// src/lib/resolve.ts
var _fs = require('fs'); var _fs2 = _interopRequireDefault2(_fs);
...
function getSyncImport(moduleProps) {
  return `
  (function() {
    var map = {
      ${moduleProps}
...
function getDynamicImport(keys, files, uid2, dirname) {
  let caseStr = "";
  files.forEach((file) => {
...
function resolveImport(files, dirname, dynamicImport) {
  const uid2 = getUID();
  let importCode = "";
  let moduleProps = "";
  let keys = [];
  files.forEach((file, index) => {
    const moduleName = getModuleName(uid2, index);
    if (!dynamicImport) {
      const moduleAbsolutePath = getModuleAbsolutePath(dirname, file);
...
`;
  ...
  const importFnCode = dynamicImport ? getDynamicImport(keys, files, uid2, dirname) : getSyncImport(moduleProps);
  return {
    importFnCode,
    importCode
  };
...
function getModuleName(uid2, index) {
  return `import_context_module_${uid2}_${index}`;
}
function getModuleAbsolutePath(dirname, file) {
  return _path2.default.resolve(dirname, file).replace(/\\/g, "/").replace(".tsx", "");
}
function resolveDir(dirname = "./", deep = false, regexp = /^\.\//) {
  let files = readDir(dirname, deep);
  if (!Array.isArray(files)) {
    files = [files];
  }
  files = files.map((file) => `./${_vite.normalizePath.call(void 0, _path2.default.relative(dirname, file))}`);
  return files.filter((file) => {
    const moduleAbsolutePath = getModuleAbsolutePath(dirname, file);
    const isFile = !_fs2.default.statSync(moduleAbsolutePath).isDirectory();
    return regexp.test(file.replace(/\\/g, "/")) && isFile;
  });
}
function readDir(dir, deep) {
  const isDirectory = _fs2.default.statSync(dir).isDirectory();
  if (deep) {
    return readDirDeep(dir);
  } else if (isDirectory) {
    const files = _fs2.default.readdirSync(dir);
    if (files) {
      return files.map((file) => _path2.default.resolve(dir, file));
    }
    return [];
  } else {
    return [dir];
...
function readDirDeep(dir) {
  const isDir = _fs2.default.statSync(dir).isDirectory();
  return isDir ? Array.prototype.concat(..._fs2.default.readdirSync(dir).map((f) => readDirDeep(_path2.default.join(dir, f)))) : dir;
}

// src/lib/codegen.ts
function patchCodeWithRequireContext(babelResult, code, id, alias) {
...
function patchCodeWithModuleHot(babelResult, code) {
...
function generateCode(code, id, alias) {
  const plugins = [];
  ...
  const babelResultByRequireContext = _core.transformSync.call(void 0, code, {
  ...
  const codeWithRequireContextTransformed = patchCodeWithRequireContext(babelResultByRequireContext, code, id, alias);
  const babelResultByModuleHot = _core.transformSync.call(void 0, codeWithRequireContextTransformed, {
  ...
  const codeWithRequireContextAndModuleHotTransformed = patchCodeWithModuleHot(babelResultByModuleHot, codeWithRequireContextTransformed);
  return codeWithRequireContextAndModuleHotTransformed;
}

// package.json
var name = "vite-plugin-vue-cli";

// src/index.ts
var import_webpack_chain = __toModule(require_Config());
var import_webpack_merge = __toModule(require_lib());
var import_lodash = __toModule(require_lodash());
var import_methods = __toModule(require_methods());
var _express = require('express'); var _express2 = _interopRequireDefault2(_express);
var resolve = (p) => _path2.default.resolve(process.cwd(), p);
var response = _express2.default.response;
function vueCli() {
  let config;
  const filter = _pluginutils.createFilter.call(void 0, ["**/*.js", "**/*.ts", "**/*.tsx", "**/*.jsx", "**/*.vue"], "node_modules/**");
  let vueConfig = {};
  return {
    name,
    enforce: "pre",
    config(config2) {
      ...
      const chainableConfig = new import_webpack_chain.default();
      ...
      const aliasOfConfigureWebpackObjectMode = _optionalChain([vueConfig, 'optionalAccess', _2 => _2.configureWebpack, 'optionalAccess', _3 => _3.resolve, 'optionalAccess', _4 => _4.alias]) || {};
      const aliasOfConfigureWebpackFunctionMode = (() => {
        if (typeof vueConfig.configureWebpack === "function") {
          ...
          originConfig = (0, import_webpack_merge.default)(originConfig, res);
          if (res) {
      ...
      config2.resolve.alias = alias;
      config2.base = process.env.PUBLIC_URL || vueConfig.publicPath || vueConfig.baseUrl || "/";
      config2.css = config2.css || {};
      config2.css.preprocessorOptions = css.loaderOptions;
      config2.server = config2.server || {};
      config2.server.strictPort = false;
      config2.server.port = Number(process.env.PORT) || devServer.port;
      config2.server.host = (process.env.DEV_HOST || devServer.public || devServer.host || "").replace("http://", "").replace("https://", ""), config2.server.open = process.platform === "darwin" || devServer.open;
      config2.server.https = devServer.https;
      config2.server.proxy = devServer.proxy;
      config2.build = config2.build || {};
      config2.build.outDir = vueConfig.outputDir || "dist";
      config2.build.cssCodeSplit = Boolean(css.extract);
      config2.build.minify = process.env.MODERN === "true" ? "esbuild" : "terser";
      config2.build.sourcemap = process.env.GENERATE_SOURCEMAP === "true" || vueConfig.productionSourceMap || css.sourceMap;
    },
    configResolved(resolvedConfig) {
      config = resolvedConfig;
    },
    configureServer(server) {
      if (typeof _optionalChain([vueConfig, 'access', _5 => _5.devServer, 'optionalAccess', _6 => _6.before]) === "function") {
        try {
          let switcher = function(method, cb) {
            return (req, res, next) => {
          ...
          import_methods.default.forEach((method) => {
            app[method] = (path4, cb) => {
              app.use(path4, switcher(method, cb));
            };
          });
          app.all = (path4, cb) => {
            app.use(path4, cb);
    ...
    transformIndexHtml: {
      enforce: "pre",
      transform(html) {
        const compiled = (0, import_lodash.template)(html);
        const vueCliData = {
